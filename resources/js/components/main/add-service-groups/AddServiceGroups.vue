        ...
        <div v-else-if="!loading" id="customer-form">
            ...
            <div class="form-row">
                <div class="form-group col-md-3">
                    ...
                    <b-form-file class="serv-form" v-model="w_file" accept=".mp3" id="i-w_line" :placeholder="(sgData.w_file === 1)?'ثبت شده':'ثبت نشده'"/>
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-1">
                    <label for="i-is_active">فعال</label>
                    <input @keyup.enter="save" type="checkbox" v-model="sgData.is_active" id="i-is_active" class="form-control"/>
                </div>
            </div>
            <h4>نماد ها</h4>
    ...
    export default {
        ...
        methods:{
            ...
            save(){
                ...
                axios.post('/api/service_group',formData,
                    {
                        headers: {
