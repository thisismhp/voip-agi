...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        "menu_opr_key" => "شماره ورودی وصل شدن به اپراتور (منو)",
        "no_charge_opr_key" => "شماره ورودی وصل شدن به اپراتور (اتمام شارژ)",
        "no_charge_sms_key" => "شماره ورودی ارسال پیامک (اتمام شارژ)",
        "sms_address" => "آدرس وب سرویس پیامک",
        "sms_username" => "نام کاربری سرویس پیامک",
        "sms_password" => "رمز عبور سرویس پیامک",
        "sms_number" => "شماره خط سرویس پیامک",
        "sms_text" => "متن پیامک",
    ],
